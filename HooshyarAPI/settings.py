"""
Django settings for HooshyarAPI project.
...
SECRET_KEY = 'django-insecure--2k-ex2twiv_=5m0#zn&y0uc!f4l&um-5_(rd*zn9-1)*9bc(w'
...
WSGI_APPLICATION = 'HooshyarAPI.wsgi.application'
